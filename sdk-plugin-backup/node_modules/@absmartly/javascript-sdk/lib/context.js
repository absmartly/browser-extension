...
class Context {
  ...
  _customFieldKeys() {
    ...
    var _iterator = _createForOfIteratorHelper(this._data.experiments),
      _step;
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        const experiment = _step.value;
        if (experiment.customFieldValues != null) {
          var _iterator2 = _createForOfIteratorHelper(experiment.customFieldValues),
            _step2;
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              const customFieldValues = _step2.value;

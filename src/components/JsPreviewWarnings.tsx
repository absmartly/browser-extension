        ...
        <div className="flex items-start gap-1.5">
          ...
          <div>
            <div className="font-medium">
              This page blocks dynamic JavaScript.
            </div>
            <div className="mt-0.5 text-amber-800">
              The page's Content Security Policy prevents both <code>eval</code>{" "}
              and inline <code>&lt;script&gt;</code>, so <code>javascript</code>{" "}
              DOM changes will not execute here or in production on this URL.
            </div>
          </div>
        </div>
      </div>
    ...
    return (
      <div
        ...
        <div className="flex items-start gap-1.5">
          ...
          <div>
            This page blocks <code>eval</code> / <code>new Function()</code>.
            JavaScript changes will try an inline <code>&lt;script&gt;</code>{" "}
            fallback; if that also fails the change won't run.
          </div>
        </div>
      </div>
    )

...
describe("EventsDebugPage", () => {
  ...
  describe("Initial State", () => {
    it("renders empty state when no events", () => {
      ...
      expect(
        screen.getByText("SDK events will appear here in real-time")
      ).toBeInTheDocument()
  ...
  describe("Pause/Resume Functionality", () => {
    ...
    it("resumes event capture when resume button clicked", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByText("Event capture paused")
  ...
  describe("Clear Functionality", () => {
    it("shows confirmation dialog and clears events when confirmed", async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText(/This will clear all 2 captured events/)
        ).toBeInTheDocument()
      })

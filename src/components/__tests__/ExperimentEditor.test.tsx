    ...
    return (
      <div data-testid="experiment-metadata">
        <select
          ...
          onChange={(e) =>
            onChange({
              unit_type_id: e.target.value ? parseInt(e.target.value) : null
            })
          }>
...
describe("ExperimentEditor", () => {
  ...
  describe("Save Functionality", () => {
    ...
    it("should update percentages when variants change", async () => {
      ...
      await waitFor(() => {
        expect(
          container.querySelector("#display-name-input")
        ).toBeInTheDocument()
      })
    })
  ...
  describe("Metadata Editing", () => {
    ...
    it("should update owners", async () => {
      render(
        <ExperimentEditor
          {...defaultProps}
          owners={[{ user_id: 1, email: "test@example.com" }]}
        />
      )
    ...
    it("should update tags", async () => {
      render(
        <ExperimentEditor
          {...defaultProps}
          tags={[{ experiment_tag_id: 1, name: "Tag A" }]}
        />
      )
  ...
  describe("Name Conversion", () => {
    it("should convert display name to snake_case", () => {
      ...
      fireEvent.change(displayNameInput, {
        target: { value: "My Cool Experiment" }
      })
  ...
  describe("Error Handling", () => {
    it("should handle save errors", async () => {
      ...
      const { container } = render(
        <ExperimentEditor {...defaultProps} onSave={mockOnSave} />
      )

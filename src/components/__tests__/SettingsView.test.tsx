...
describe("SettingsView", () => {
  ...
  describe("Authentication Method", () => {
    it("should render JWT and API Key radio buttons", () => {
      const { container } = render(
        <SettingsView onSave={mockOnSave} onCancel={mockOnCancel} />
      )
    ...
    it("should select JWT by default", () => {
      ...
      const jwtRadio = document.querySelector(
        "#auth-method-jwt"
      ) as HTMLInputElement
    ...
    it("should show correct helper text for JWT auth", () => {
      ...
      expect(
        screen.getByText(/Uses JWT token from browser cookies/i)
      ).toBeInTheDocument()
    })
    ...
    it("should show correct helper text for API Key auth", () => {
      ...
      expect(
        screen.getByText(/Uses the API key configured below/i)
      ).toBeInTheDocument()
    })
  })
  ...
  describe("Save Settings", () => {
    ...
    it("should store normalized endpoint in localStorage", async () => {
      ...
      await waitFor(() => {
        expect(mockNormalizeEndpoint).toHaveBeenCalledWith(
          "https://api.absmartly.com"
        )
        expect(localStorage.getItem("absmartly-endpoint")).toBe(
    ...
    it("should handle save error gracefully", async () => {
      ...
      await waitFor(() => {
        expect(mockSetErrors).toHaveBeenCalledWith({
          general: "Failed to save settings"
        })
      })
    })
  })
  ...
  describe("Authenticate", () => {
    it("should open ABsmartly login page in new tab", () => {
      ...
      const authenticateButtons = screen.getAllByRole("button", {
        name: /Authenticate/i
      })

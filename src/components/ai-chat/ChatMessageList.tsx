    ...
    return (
      <div className="flex flex-col items-center justify-center h-full text-center px-4">
        ...
        <p className="text-gray-600 max-w-md mb-4">
          Describe what you want to change on the page, and the AI will analyze
          the HTML and generate the appropriate DOM changes for you.
        </p>
        <p className="text-sm text-purple-600 font-medium mb-2">
          💡 You can paste or drag images to help the AI understand your
          request!
        </p>
        ...
        <div
          ...
          <div
              ...
              (message.role === "assistant" && message.aiResponse ? (
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: renderMarkdown(message.aiResponse)
                  }}
                />
              ) : (
            ...
            {message.role === "assistant" &&
              ...
              message.domChangesSnapshot.length > 0 && (
                    ...
                    onClick={() => {
                      if (message.domChangesSnapshot) {
                        ...
                        if (!previewEnabledOnce) {
                          debugLog(
                            "[ChatMessageList] Enabling preview after restoring changes from history"
                          )
                          ...
                          debugLog(
                            "[ChatMessageList] Refreshing preview after restoring changes from history"
                          )
                          if (onRestoreChangesCallback) {
                            onRestoreChangesCallback(message.domChangesSnapshot)
                          }

...
interface AuthenticationStatusSectionProps {
  ...
  onCheckAuth: (
    endpoint: string,
    config: { apiKey: string; authMethod: "jwt" | "apikey" }
  ) => void
  onAuthenticate: () => void
}

export const AuthenticationStatusSection = React.memo(
  function AuthenticationStatusSection({
    checkingAuth,
    user,
    avatarUrl,
    apiEndpoint,
    ...
    return (
      <div
        ...
        data-testid="auth-status-section">

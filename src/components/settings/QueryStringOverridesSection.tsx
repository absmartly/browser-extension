...
export const QueryStringOverridesSection = React.memo(
  function QueryStringOverridesSection({
    queryPrefix,
    ...
    return (
      <div className="border-t pt-4 mt-4">
        ...
        <p className="mt-1 text-xs text-gray-500">
          Prefix for query parameters (e.g., ?{DEFAULT_CONFIG.queryPrefix}
          button_color=1)
        </p>
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          />
          <label
            htmlFor="persistQueryToCookie"
            className="block text-sm text-gray-700 cursor-pointer">
            Persist query string overrides to cookie
          </label>
        </div>
        <p className="mt-1 text-xs text-gray-500">
          When enabled, query string overrides will be saved to a cookie for

...
export function MultiSelectTags({
  ...
  return (
    <div
      className={`border rounded-md p-2 min-h-[42px] focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 ${className}`}>
      <div className="flex flex-wrap gap-1.5 items-center">
        ...
        <input
          ...
          placeholder={
            currentClasses.length === 0 ? placeholder : "Add class..."
          }

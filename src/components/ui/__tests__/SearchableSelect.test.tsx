...
describe("SearchableSelect", () => {
  ...
  describe("Multi Select Mode", () => {
    ...
    it("should select multiple options by reopening dropdown", () => {
      ...
      // Click second option
      fireEvent.click(
        screen.getAllByText("Option 2")[1] || screen.getByText("Option 2")
      )
    ...
    it("should deselect option when clicking selected option", () => {
      ...
      fireEvent.click(
        trigger.closest("[data-testid]") || trigger.parentElement!
      )

      // Click already selected option
      const option2 = screen
        .getAllByText("Option 2")
        .find((el) => el.closest(".hover\\:bg-gray-50"))

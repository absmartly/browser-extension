...
export function AIDOMChangesView({
  aiDomContext,
  onBackFromAI
}: AIDOMChangesViewProps) {
  if (!aiDomContext) {
    console.error(
      "[AIDOMChangesView] Missing aiDomContext - this indicates a routing issue"
    )
    return (
      <div
        id="ai-dom-changes-view-error"
        className="flex flex-col items-center justify-center h-screen p-8 bg-yellow-50">
        <div className="text-center max-w-md">
          <h2
            id="ai-missing-context-heading"
          ...
          <Button onClick={onBackFromAI}>← Go Back</Button>
        </div>
      </div>
    )
  }
  ...
  debugLog(
    "[AIDOMChangesView] Rendering with context for variant:",
    aiDomContext.variantName
  )
  ...
  return (
    <div id="ai-dom-changes-view">
      <ErrorBoundary
        fallback={
          <div
            id="ai-dom-changes-view-error-boundary"
            className="flex flex-col items-center justify-center h-screen p-8 bg-red-50">
            <div className="text-center max-w-md">
              <h2
                id="ai-error-heading"
              ...
              <Button
                id="return-to-variant-editor-button"
                onClick={onBackFromAI}>

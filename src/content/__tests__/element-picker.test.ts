...
describe("ElementPicker", () => {
  ...
  describe("stop", () => {
    it("should remove overlay and notification", () => {
      ...
      expect(
        document.querySelector('div[style*="z-index: 999999"]')
      ).not.toBeInTheDocument()
      expect(
        document.querySelector('div[style*="z-index: 1000000"]')
      ).not.toBeInTheDocument()
    })
    ...
    it("should clean up highlight overlays", () => {
      ...
      expect(
        document.querySelector(".absmartly-element-highlight")
      ).not.toBeInTheDocument()
    })
  })
  ...
  describe("selector generation", () => {
    it("should generate unique selector for element with ID", () => {
      ...
      expect(mockCallback).toHaveBeenCalledWith(
        expect.stringMatching(/unique-button/)
      )
    })
  ...
  describe("edge cases", () => {
    ...
    it("should clean up animation styles on stop", () => {
      ...
      const animationStyle = document.querySelector(
        "style[data-absmartly-animation]"
      )
      ...
      expect(
        document.querySelector("style[data-absmartly-animation]")
      ).not.toBeInTheDocument()
    })

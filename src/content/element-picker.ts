...
export class ElementPicker {
  ...
  private generateSelector(element: Element, debug = false): string {
    // Use semantic-first strategy with maximum parent levels
    // The algorithm will automatically find the best semantic parent
    const selector = generateRobustSelector(element, {
      preferDataAttributes: true,
      includeParentContext: true,
      maxParentLevels: 12,  // Increased to reach higher-level semantic parents like "Hero section"

...
function TestComponent() {
  ...
  return (
    <div>
      <button id="show-error" onClick={() => showError("Error message")}>
        Show Error
      </button>
      <button id="show-warning" onClick={() => showWarning("Warning message")}>
        Show Warning
      </button>
      <button id="show-success" onClick={() => showSuccess("Success message")}>
        Show Success
      </button>
      <button id="show-info" onClick={() => showInfo("Info message")}>
        Show Info
      </button>
      <button
        id="show-error-with-action"
        onClick={() =>
...
describe("NotificationContext", () => {
  ...
  it("should show error toast with action button", () => {
    ...
    act(() => {
      document
        .querySelector<HTMLButtonElement>("#show-error-with-action")!
        .click()
    })

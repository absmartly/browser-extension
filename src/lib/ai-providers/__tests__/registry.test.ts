...
import { getProviderOrigins, PROVIDER_REGISTRY } from "../registry"
...
describe("Provider Registry", () => {
  describe("PROVIDER_REGISTRY", () => {
    ...
    const BRIDGE_PROVIDERS: AIProviderType[] = ["claude-subscription", "codex"]
    ...
    describe("API providers", () => {
      ...
      it.each(API_PROVIDERS)(
        "%s should have a non-empty defaultEndpoint",
        (id) => {
  ...
  describe("getProviderOrigins()", () => {
    ...
    it("should return both custom and default endpoint origins when custom endpoint is set", () => {
      const origins = getProviderOrigins(
        "anthropic-api",
  ...
  describe("Provider modelConfig", () => {
    describe("AnthropicProvider", () => {
      it("should have a static modelConfig", () => {
        ...
        expect(AnthropicProvider.modelConfig.defaultEndpoint).toBe(
      ...
      it("parseModels should handle empty data gracefully", () => {
        ...
        expect(
          AnthropicProvider.modelConfig.parseModels({ data: null })
        ).toEqual([])
      })
    })
    ...
    describe("OpenAIProvider", () => {
      it("should have a static modelConfig", () => {
        ...
        expect(OpenAIProvider.modelConfig.defaultEndpoint).toBe(
    ...
    describe("OpenRouterProvider", () => {
      it("should have a static modelConfig", () => {
        ...
        expect(OpenRouterProvider.modelConfig.defaultEndpoint).toBe(
      ...
      it("parseModels should handle empty data gracefully", () => {
        ...
        expect(
          OpenRouterProvider.modelConfig.parseModels({ data: [] })
        ).toEqual([])
        expect(
          OpenRouterProvider.modelConfig.parseModels({ data: null })
        ).toEqual([])
      })
    })
    ...
    describe("GeminiProvider", () => {
      ...
      it("parseModels should handle empty data gracefully", () => {
        ...
        expect(
          GeminiProvider.modelConfig.parseModels({ models: null })
        ).toEqual([])
      })
    })
  })

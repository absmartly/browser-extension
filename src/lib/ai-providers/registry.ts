...
import type { AIProviderType, ModelInfo } from "./base"
...
export interface ProviderMetadata {
  ...
  ) => Promise<ModelInfo[] | GroupedModels>
...
export const PROVIDER_REGISTRY: Record<AIProviderType, ProviderMetadata> = {
  ...
  "anthropic-api": {
    ...
    endpointDescription:
      "Optional: Use a custom API endpoint (e.g., for proxy or self-hosted deployments). Leave blank for default.",
    modelLabel: "Claude Model",
    modelHelpText:
      "Models are fetched from the API. Select the Claude model to use for generating DOM changes.",
    modelDisplayType: "simple",
    fetchModels: (apiKey, endpoint) =>
  ...
  "openai-api": {
    ...
    endpointDescription:
      "Optional: Use a custom OpenAI-compatible endpoint (e.g., local LLM, Azure OpenAI). Leave blank for default.",
    modelLabel: "Model",
  ...
  "gemini-api": {
    ...
    endpointDescription:
      "Optional: Use a custom Gemini-compatible endpoint. Leave blank for default.",
    modelLabel: "Model",

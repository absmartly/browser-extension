...
describe('CodeInjector', () => {
  ...
  // NOTE: matchesUrlFilter tests are in E2E suite (tests/e2e/url-filtering*.spec.ts)
  // Unit testing URL filter logic requires complex window.location mocking in JSDOM
  // which is not reliable. The functionality is thoroughly tested in E2E tests instead.

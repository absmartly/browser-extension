...
describe("sanitizeHTML", () => {
  describe("basic functionality", () => {
    ...
    it("should preserve safe elements", () => {
      const html =
        '<p>Text</p><span>More</span><a href="https://example.com">Link</a>'
  ...
  describe("edge cases", () => {
    ...
    it("should handle deeply nested safe HTML", () => {
      const html =
        "<div><div><div><p>Deep <strong>text</strong></p></div></div></div>"
      const result = sanitizeHTML(html)
  ...
  describe("real-world use cases", () => {
    ...
    it("should handle DOM changes from experiments", () => {
      const experimentHTML =
        '<div class="banner"><h3>New Feature!</h3><p>Try it now</p></div>'

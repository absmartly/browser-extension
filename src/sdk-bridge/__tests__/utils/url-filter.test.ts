...
describe("URLFilterMatcher", () => {
  ...
  describe("matchesUrlFilter", () => {
    it("should return true when no filter is provided", () => {
      ...
      expect(URLFilterMatcher.matchesUrlFilter(undefined, mockLocation)).toBe(
        true
      )
    })
    ...
    describe("string filters", () => {
      it("should match exact path", () => {
        expect(
          URLFilterMatcher.matchesUrlFilter("/products/item", mockLocation)
        ).toBe(true)
      })

      it("should not match different path", () => {
        expect(
          URLFilterMatcher.matchesUrlFilter("/other/path", mockLocation)
        ).toBe(false)
      })
      ...
      it("should match path with wildcards", () => {
        ...
        expect(URLFilterMatcher.matchesUrlFilter("/prod*", mockLocation)).toBe(
          true
        )
      ...
      it("should match path with question mark wildcard", () => {
        expect(
          URLFilterMatcher.matchesUrlFilter("/products/ite?", mockLocation)
        ).toBe(true)
      })
    })
    ...
    describe("exclude patterns", () => {
      ...
      it("should check exclude patterns before include patterns", () => {
        ...
        expect(URLFilterMatcher.matchesUrlFilter(filter, mockLocation)).toBe(
          false
        )
    ...
    describe("wildcard mode", () => {
      it("should convert * to .* for any characters", () => {
        ...
        expect(
          URLFilterMatcher.matchesUrlFilter("/**/item", mockLocation)
        ).toBe(true) // ** is two wildcards that match /products/
        expect(
          URLFilterMatcher.matchesUrlFilter("/services/*", mockLocation)
        ).toBe(false) // Different path
      })
      ...
      it("should convert ? to . for single character", () => {
        ...
        expect(
          URLFilterMatcher.matchesUrlFilter("/products/it?m", mockLocation)
        ).toBe(true)
        expect(
          URLFilterMatcher.matchesUrlFilter("/products/i???", mockLocation)
        ).toBe(true)
      })

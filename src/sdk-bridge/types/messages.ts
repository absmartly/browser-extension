...
export function isExtensionMessage(msg: unknown): msg is ExtensionMessage {
  ...
  const validSources: MessageSource[] = [
    "absmartly-page",
    "absmartly-extension"
  ]
  const validTypes = [
  ...
  return (
    validSources.includes(m.source as MessageSource) &&
    validTypes.includes(m.type as string)
  )
}

export function isSDKEventMessage(
  msg: ExtensionMessage
): msg is Extract<ExtensionMessage, { type: "SDK_EVENT" }> {

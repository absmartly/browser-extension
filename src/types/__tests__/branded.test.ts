...
describe("Branded Types", () => {
  describe("ExperimentId", () => {
    describe("experimentId constructor", () => {
      ...
      it("should reject zero", () => {
        expect(() => experimentId(0)).toThrow(
          "Invalid experiment ID: 0. Must be a positive integer."
        )
      })

      it("should reject negative numbers", () => {
        expect(() => experimentId(-1)).toThrow(
          "Invalid experiment ID: -1. Must be a positive integer."
        )
        expect(() => experimentId(-42)).toThrow(
          "Invalid experiment ID: -42. Must be a positive integer."
        )
      })

      it("should reject floats", () => {
        expect(() => experimentId(3.14)).toThrow(
          "Invalid experiment ID: 3.14. Must be a positive integer."
        )
        expect(() => experimentId(1.5)).toThrow(
          "Invalid experiment ID: 1.5. Must be a positive integer."
        )
      })

      it("should reject NaN", () => {
        expect(() => experimentId(NaN)).toThrow(
          "Invalid experiment ID: NaN. Must be a positive integer."
        )
      })

      it("should reject Infinity", () => {
        expect(() => experimentId(Infinity)).toThrow(
          "Invalid experiment ID: Infinity. Must be a positive integer."
        )
        expect(() => experimentId(-Infinity)).toThrow(
          "Invalid experiment ID: -Infinity. Must be a positive integer."
        )
  ...
  describe("VariantName", () => {
    describe("variantName constructor", () => {
      ...
      it("should reject non-strings", () => {
        ...
        expect(() => variantName(undefined as any)).toThrow(
  ...
  describe("CSSSelector", () => {
    describe("cssSelector constructor", () => {
      ...
      it("should reject non-strings", () => {
        ...
        expect(() => cssSelector(undefined as any)).toThrow(
  ...
  describe("XPathSelector", () => {
    describe("xpathSelector constructor", () => {
      it("should accept non-empty strings", () => {
        ...
        expect(xpathSelector('//button[@id="submit"]')).toBe(
          '//button[@id="submit"]'
        )
      ...
      it("should reject non-strings", () => {
        expect(() => xpathSelector(null as any)).toThrow(
          "Invalid XPath selector"
        )
        expect(() => xpathSelector(undefined as any)).toThrow(
          "Invalid XPath selector"
        )
      })
    })
  ...
  describe("APIEndpoint", () => {
    describe("apiEndpoint constructor", () => {
      it("should accept valid HTTP URLs", () => {
        expect(apiEndpoint("http://localhost:3000")).toBe(
          "http://localhost:3000"
        )
        expect(apiEndpoint("http://example.com")).toBe("http://example.com")
        expect(apiEndpoint("http://api.example.com/v1")).toBe(
          "http://api.example.com/v1"
        )
      })

      it("should accept valid HTTPS URLs", () => {
        expect(apiEndpoint("https://api.absmartly.com")).toBe(
          "https://api.absmartly.com"
        )
        expect(apiEndpoint("https://example.com:8080")).toBe(
          "https://example.com:8080"
        )
        expect(apiEndpoint("https://api.example.com/v1/experiments")).toBe(
          "https://api.example.com/v1/experiments"
        )
      })

      it("should trim whitespace", () => {
        expect(apiEndpoint("  https://api.example.com  ")).toBe(
      ...
      it("should reject non-HTTP(S) protocols", () => {
        expect(() => apiEndpoint("ftp://example.com")).toThrow(
          "Protocol must be http or https"
        )
        expect(() => apiEndpoint("file:///etc/passwd")).toThrow(
          "Protocol must be http or https"
        )
        expect(() => apiEndpoint("javascript:alert(1)")).toThrow(
      ...
      it("should reject invalid URLs", () => {
        expect(() => apiEndpoint("not a url")).toThrow(
          "Invalid API endpoint URL"
        )
        expect(() => apiEndpoint("://invalid")).toThrow(
          "Invalid API endpoint URL"
        )
      })
      ...
      it("should reject non-strings", () => {
        ...
        expect(() => apiEndpoint(undefined as any)).toThrow(
    ...
    describe("applicationId constructor", () => {
      ...
      it("should reject zero", () => {
        expect(() => applicationId(0)).toThrow(
          "Invalid application ID: 0. Must be a positive integer."
        )
      })

      it("should reject negative numbers", () => {
        expect(() => applicationId(-1)).toThrow(
          "Invalid application ID: -1. Must be a positive integer."
        )
      })

      it("should reject floats", () => {
        expect(() => applicationId(3.14)).toThrow(
          "Invalid application ID: 3.14. Must be a positive integer."
        )
      })
    })
  ...
  describe("ConversationId", () => {
    describe("conversationId constructor", () => {
      ...
      it("should reject non-strings", () => {
        expect(() => conversationId(null as any)).toThrow(
          "Invalid conversation ID"
        )
        expect(() => conversationId(undefined as any)).toThrow(
          "Invalid conversation ID"
        )
      })
    })

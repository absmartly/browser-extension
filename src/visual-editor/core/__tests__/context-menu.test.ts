...
describe("ContextMenu", () => {
  ...
  describe("Menu Items", () => {
    it("should not include Move up and Move down in menu items", () => {
      ...
      const labels = Array.from(menuItems).map(
        (item: any) => item.querySelector(".menu-label")?.textContent
      )
  ...
  describe("Menu Items Creation", () => {
    ...
    it("should create menu items with correct structure", () => {
      ...
      const actions = menuItems.filter(
        (item): item is MenuAction => !("divider" in item)
      )
    ...
    it("should include shortcuts for specific actions", () => {
      ...
      const copySelector = actionsWithShortcuts.find(
        (item) => item.action === "copySelector"
      )
      const deleteAction = actionsWithShortcuts.find(
  ...
  describe("Menu Item Icons and Labels", () => {
    ...
    it("should have descriptive labels for actions", () => {
      ...
      const deleteAction = menuItems.find(
        (item): item is MenuAction =>

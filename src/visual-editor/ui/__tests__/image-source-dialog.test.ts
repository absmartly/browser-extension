...
describe("ImageSourceDialog", () => {
  ...
  describe("validateImageUrl", () => {
    it("should validate https URLs", () => {
      expect(dialog.validateImageUrl("https://example.com/image.jpg")).toBe(
        true
      )
    })
    ...
    it("should validate data URLs", () => {
      expect(
        dialog.validateImageUrl("data:image/png;base64,iVBORw0KGgo=")
      ).toBe(true)
    })
  ...
  describe("show", () => {
    it("should create dialog in DOM", async () => {
      ...
      expect(
        document.getElementById("absmartly-image-dialog-host")
      ).toBeTruthy()
    ...
    it("should return new URL when applied with valid URL", async () => {
      ...
      const applyButton = shadowRoot.querySelector(
        ".dialog-button-apply"
      ) as HTMLElement
